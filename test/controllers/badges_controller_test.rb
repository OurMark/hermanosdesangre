...
class BadgesControllerTest < ActionController::TestCase
  ...
  test "should create badge" do
    assert_difference('Badge.count') do
      post :create, badge: { description: @badge.description, icon: @badge.icon, name: @badge.name, value: @badge.value }
    end
  ...
  test "should update badge" do
    patch :update, id: @badge, badge: { description: @badge.description, icon: @badge.icon, name: @badge.name, value: @badge.value }
    assert_redirected_to badge_path(assigns(:badge))
  end
